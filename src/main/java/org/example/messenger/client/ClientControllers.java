...
import org.example.messenger.messages.LoginMessage;
import org.example.messenger.messages.RegisterMessage;
...
public class ClientControllers {
    ...
    protected void onWantToRegisterButtonClick() {
            ...
            sceneLoader.loadScene("/org/example/messenger/client/authorization.fxml", currentStage, "Authorization",
                    clientConnection);
    }
            ...
            try {
                ...
                Platform.runLater(() -> {
                    if (type.equals("success")) {
                        ...
                        sceneLoader.loadMainScene("/org/example/messenger/client/mainPage.fxml", stage, username, clientConnection);
    ...
    protected void onReturnButtonClick() {
        ...
        sceneLoader.loadScene("/org/example/messenger/client/login.fxml", currentStage, "Login",
                clientConnection);
    }
}
