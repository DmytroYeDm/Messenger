...
import org.example.messenger.messages.InitializeUsersMessage;
import org.example.messenger.messages.SendMessageToUserMessage;
import org.example.messenger.messages.GetChatMessagesMessage;
import org.example.messenger.models.Message;
import org.example.messenger.models.UserView;
...
public class MessengerControllers implements MessageHandler{
    ...
    public void initialize() {
        ...
        try {
            ...
            sceneLoader.loadProblemScene("/org/example/messenger/client/clientProblem.fxml", stage, "Problem");
            return;
        }
        try {
            ...
            allUsers = FXCollections.observableArrayList(); // автоматично повідомляє про зміни
